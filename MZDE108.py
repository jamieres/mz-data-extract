...
print "----------------------------------"
print Fore.WHITE + Style.NORMAL + "  TimeStamp:", Style.DIM + str(datetime.datetime.fromtimestamp(pe.FILE_HEADER.TimeDateStamp)), Fore.GREEN + " - " + str(pe.FILE_HEADER.TimeDateStamp) + " - " 
print Fore.WHITE + Style.NORMAL + "  EntryPoint: " + Style.DIM + hex(pe.OPTIONAL_HEADER.AddressOfEntryPoint), Fore.GREEN + " - " + str(pe.OPTIONAL_HEADER.AddressOfEntryPoint) + " - " 
