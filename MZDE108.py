...
import sys,os,re,subprocess,datetime,time,shlex,stat,colorama,hashlib,binascii,ssdeep,fuzzyhashlib,bz2,string,bitstring,struct,pefile,peutils,argparse
...
magic = subprocess.check_output(["file", "-b", filename])
mimetype = subprocess.check_output(["file", "--mime-type", "-b", filename])
