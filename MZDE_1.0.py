...
for found_str in ab(NETINT):
   jam = re.findall("(\w*\.(sys|log|txt|ini|inf|xml|doc|xls|ppt|exe|cpl|pas|bat|pdf|swf|jpg|ico|php|asp|aspx|cgi|htm|css|pdb|zip|cab|nfo|lnk|scr|py))+", found_str, re.IGNORECASE | re.MULTILINE)
